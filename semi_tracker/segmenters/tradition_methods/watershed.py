...
class WaterShed:
    ...
    def __call__(self, img, makers=None):
        ...
        if makers is None:
            ...
            opening = cv2.morphologyEx(thresh_img, cv2.MORPH_OPEN, kernel, iterations = self.noise_amplitude)
            ...
            _, sure_fg = cv2.threshold(dist_transform, self.dist_thresh  * dist_transform.max(),  255, 0)
